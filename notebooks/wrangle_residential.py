...
# %%
census_2011_small_area_hhs = pd.read_csv(data_dir / "census_2011_small_area_hhs.csv")
...
# %%
create_dublin_ber_private(data_dir, dublin_small_area_boundaries_2016)

# %%
census_2011_hh_indiv = pd.read_csv(data_dir / "census_2011_hh_indiv.csv")
