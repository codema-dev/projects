...
small_areas_2011_vs_2016.to_csv(data_dir / "small_areas_2011_vs_2016.csv", index=False)
...
dublin_small_area_boundaries_2016_with_las = get_geometries_within(
    dublin_small_area_boundaries_2016, dublin_municipality_boundaries.to_crs(epsg=2157)
).rename(columns={"COUNTYNAME": "local_authority"})
dublin_small_area_boundaries_2016_with_las.to_file(
    data_dir / "dublin_small_area_boundaries_2016.geojson", driver="GeoJSON"
)
# %%
